...
--   5. 2026-09-17 (evening): bank_inflow_inr — money that actually ARRIVED
--      in the bank for this scope (verified bank-recon credits only:
--      bank_recon_links.target_type = 'order_sale'/'bill_payment'-credit
--      style links, i.e. every linked CREDIT statement line). The user
--      wants order value vs bank receipts side by side: "bank me jo pese
--      aaye or order value dono ka difrance bhi pata chalna chhiye".
--      Unlinked credits are NOT counted (they'd be guesses) — the
--      unmatched backlog stays visible in /dashboard/bank-recon.
--
